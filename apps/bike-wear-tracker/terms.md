...
layout: page
link: https://crazyhorseapps.com/apps/bike-wear-tracker/terms
slug: bike-wear-tracker/terms
title: Terms of Service - Bike Wear Tracker
---

The following Terms of Use and End User License Agreement (“EULA”) constitute an agreement between you (“You”) and A. Caltieri Apps di Alain Caltieri (“Service Provider”), governing the use of the software applications downloaded through the Apple App Store (the “Licensed Application(s)”). For questions, complaints or claims with respect to the Licensed Application, please contact [apps.crazy.horse@gmail.com](mailto:apps.crazy.horse@gmail.com).
...
#### Mechanical and Safety Disclaimer

The wear metrics and component status provided by the Licensed Application are mathematical estimates based on third-party data and user input. The Licensed Application is not a substitute for regular, professional mechanical inspection and maintenance of your bicycle. The Service Provider makes no warranties regarding the actual physical condition, safety, or reliability of your bicycle or any of its components.

Cycling involves inherent risks. You agree that you are solely responsible for physically inspecting your equipment before each use and ensuring it is safe to ride. In no event shall the Service Provider be liable for any equipment failure, property damage, personal injury, or death resulting from your reliance on the data or estimates provided by the Licensed Application.

#### Third-Party API Reliance

The core functionality of the Licensed Application relies on data retrieved from third-party services, specifically the Strava API. The Service Provider is not responsible for any data inaccuracies, syncing failures, or service interruptions caused by these third-party platforms. You acknowledge and agree that the Service Provider reserves the right to modify, suspend, or discontinue the Licensed Application, without liability or obligation for refunds, should the third-party provider restrict, modify, or terminate our access to their API.
